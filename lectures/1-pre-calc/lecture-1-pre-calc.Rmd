...
- Integers (whole numbers): $\mathbb{Z}$
...
Isolate an unknown term to express it in terms of known terms
...
| Michelangelo's    | Capitol       | 8      | fair | bathroom key 
...
You will learn all of these (if you take 812, 813, MLE, etc.)
