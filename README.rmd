...
- The easiest way to view slides is to use the PDF files. PDFs of the slides can be found in the `/lectures/pdf/`  folder. These should open in the Preview or Adobe Reader applications, depending on your computer. 
