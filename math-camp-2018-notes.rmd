...
- don't let thoughts about methods fuck up the changes to math camp
- arithmetic and concepts can't be too far apart
- if the purpose is to prepare for 812 then R isn't important
- more emphasis on the algebra, linear algebra, inequalities
- afternoon structured study hall
